...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-0 z-[100] flex max-h-screen w-full flex-col-reverse sm:flex-col p-4 sm:bottom-0 sm:right-0 sm:max-w-[420px]",
      className
    )}
    {...props}
  />
